...
/***/ function(module, exports, __webpack_require__) {
	  ...
	  render: function render() {
	    return React.createElement(
	      ...
	      React.createElement(
	        'div',
	        null,
	        React.createElement('input', { placeholder: 'Enter name', type: 'text', ref: 'name' })
	      ),
	      React.createElement(
	        'div',
	        null,
	...
	var Greeter = React.createClass({
	  ...
	  handleNewDate: function handleNewDate(updates) {
	...
	ReactDOM.render(React.createElement(Greeter, null), // This gets passed from the method above
